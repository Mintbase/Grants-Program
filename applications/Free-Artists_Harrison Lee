...
We're building a fan financing platform (freeartists.xyz); where fans can contribute & participate in the upside of the full revenue of a creator. 

Free-Artists is a P2P creator financing platform initially focused on creating better financial deals for creators (i.e.music artists). The traditional label model/system suffers from a lack of transparency, and often features bad economics (90/10 revenue splits in favor of record labels). In these deals, artists often lose control of their projects.
Free-Artists will allow creators to raise capital directly from their fans in exchange for revenue rights. This puts artists in control of their contracts, enabling more fair economics and full autonomy. Our protocol is built on the blockchain, which at scale will allow it to run as a community-owned and fully transparent public utility.
Our core team has hyper-relevant experience: finance, music and Web3 infrastructure. We also have a deep network of innovative artists and industry professionals rooting for us to build this for them. Free-Artists is not a self-referential DeFi project like many are today–it coordinates capital on-chain, deploys it off-chain into the real world and then brings the resultant value back on-chain.

After launching the smart contract (for revenue distribution) on Aurora testnet last week (and mainnet this coming week), we're planning to build an automated proposal build & the ability to share updates.
We'd love to explore using permanent web storages with Mintbase for transparency & the ability to present personalized recommendations for backers & creators.
Proper tracking & cleaning of this data is crucial to build out recommendations, which is why we're excited to build with you.

### Project Details

- Mockups/designs of any UI components - https://www.figma.com/proto/g7Edk2JCOMLpRAw9v8NJ4c/FA-Product-Wireframe---working-file?node-id=94%3A9640&scaling=scale-down&page-id=2%3A148&starting-point-node-id=94%3A9640&show-proto-sidebar=1
- Pitch Deck - https://docs.google.com/presentation/d/1Pc3p-yKqI9FSr2_-XSiY19iRNFW6RKdOQls8D7dl8IM/edit?usp=sharing
- Details & Tech Implementation - https://docs.google.com/document/d/1ZJLZZePHGvtxnvjd4accZZvvzt7n5DFcFLwc76ZpYbo/edit?usp=sharing
- White-Paper - https://docs.google.com/document/d/1yALmLyMbFjKMW2puWWMkye90JGw5UzzrxtvLUXerEH0/edit?usp=sharing
...
- **Contact Name:** Harrison Lee
- **Contact Email:** harrison.lee@useriff.com
- **Website:** freeartists.xyz
...
Team
- Madeleine: community manager (sweatcoin, deepwaters.xyz) - grown communities from 500 to 27,000 (no paid ads, no bots, 12% engagement during peak bear market)
- Weavik: design/dev shop experienced in crowdsourced equity & web3 platforms
- Aaron: finance/legal for web3 (credentialed lawyer)

### Team Code Repos

- https://github.com/weavik/free-artist-dao/blob/old-main/packages/client/src/ethereum/gasless.ts
- testnet launch: https://dmtbrvhp2ta0b.cloudfront.net/

Please also provide the GitHub accounts of all team members. If they contain no activity, references to projects hosted elsewhere or live are also fine.

Engineers (working on Free-Artists MVP)
- https://github.com/ctindogaru
- https://github.com/luansievers
- https://github.com/sachasmart-weavik
- https://github.com/v1n33th
- engineer focused on Mintbase project: github.com/mattbrc

### Team LinkedIn Profiles (if available)

Business/Product Architecture
- Chris: https://www.linkedin.com/in/christophercreatura?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAAARXJJoBUa6Itz1zvFtoL8yJYSv8W5DLDPU&lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_all%3B0%2F9ESTcJToGBCc%2Fw%2Bx1LEw%3D%3D
- Harrison: https://www.linkedin.com/in/harrison-lee-a739515a/
- Stevie: https://www.linkedin.com/in/stephen-j-trim?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAABYGIisBZzgPgqMwTlEBgcy2I93ZsP-pUE4&lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_all%3BgatQAj5kQCahbPodFiKgLQ%3D%3D
