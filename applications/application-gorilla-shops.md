...
Gorilla Shops builds store fronts with a connected CMS based on Mintbase Smart Contracts. These store fronts can be easily set up with the Gorilla Shops Page Builder and can easily be adjusted to the needs of a store owner of a Mintbase Store. We are also going to implement additional functionalities like token-gated content. The store fronts enhance Mintbase' functionality and hereby delivers value to the Mintbase and NEAR ecosystem. Gorilla Shops wants to become the Shopify for NFT-Shops built on top of Mintbase.
...
Gorilla Shops enhances the functionality of Mintbase and strives to become a hub for _store front development_.
...
musicians but also journalists can leverage Mintbase without any technical expertise.

- Who is your target audience (parachain/dapp/wallet/UI developers, designers, your own user base, some dapp's userbase, yourself)?

Firstly, we target the users of Mintbase stores. We want them to be able to set up store fronts by a click of a button that are a helpful tool to build their business model around their products. Secondly, we target developers and designers. We want them to be able to easily add themes and components for the store fronts that can be added from within the page builder. Our goal is to create a system that helps designers and developers to create an additional source of income by providing theme presets and components to our system.
...
- Jakob Sievers: Former teacher for physics, chemistry and computer science. Founded the Gorilla Funds UG in 2020. I discovered the blockchain space in 2012 and since then got caught in the rabbit hole. Coding experience of 15+ years.
...
- Tobias Metz: Tobias Metz is an full stack software engineer from South-West Germany. He had worked in several  web-agencies  and hardware/network B2B companies as well. He has an information technology background and ~10 years of customer/developer experience.
...
We have a working product that got released today after a 3 month long beta phase. The current version number is v1.1.
...
|     1. | Additional UI-Components: | We will create additional UI-Components that can easily be dropped in via our CMS. These are: A blog teaser, an NFT-Product-Teaser, a video-component (YouTube/Vimeo), a Page-Teaser, a Contact-Form-Component. The Design of these components can be viewed here: https://www.figma.com/file/bx0r402Qt0bKPKEbHrhMrw/Shop-Pages?node-id=2015%3A6864 |
...
- Code will be released under the MIT License.

| Number | Deliverable            | Specification                                                                                                                                                                                                                                                                                                                                    |
| -----: | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|    0a. | License                | MIT                                                                                                                                                                                                                                                                                                                                              |
|    0b. | Documentation          | We will provide both **inline documentation** of the code and a basic **tutorial** that explains how a user can set up a Web Shop with a connected CMS without the Page Builder                                                                                                                                                                    |
|    0c. | Testing Guide          | Core functions will be fully covered by unit tests to ensure functionality and robustness. In the guide, we will describe how to run these tests.                                                                                                                                                                                                |
|    0d. | Docker                 | We will provide a Testnet-instance that can be used to test all the functionalites of our product. We will also provide a Docker-image that can be used to test it without our builder.                                                                                                                                                          |
|    0e. | Article                | We will publish an **article** that explains all features and how to use them as well as two-weekly development updates in our Discord-channel.                                                                                                                                                                                                  |
...
We will release the front-end code that is used for building our front-ends as well as the code for the Sanity-CMS so that a developer can set this up and build upon this from this repostitory without using the Builder. We will provide a clear documentation about how this works. The code for the Builder is not part of this Grant Proposal. We will keep the Builder closed source for now.
