...
![image](https://raw.githubusercontent.com/rainbowcitykun/Grants-Program/master/pic/26.png)


![image](https://raw.githubusercontent.com/rainbowcitykun/Grants-Program/master/pic/27.png)
...
|     4. | ink! Contract: userManage | This contract is a user management contract. Manage user registration, user management, and referral relationships for the entire protocol. |
|     5. | ink! Contract: incomeCategory | This contract is an income category management contract. Mainly used to calculate the income category and income ratio of the protocol.|
|     6. | ink! Contract: roleManage   | This contract belongs to the role management contract and is mainly used to manage the role of the protocol. |
