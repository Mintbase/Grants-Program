...
- **Team Name:** CommandLine Technologies Ltd
...
- Niftiqet is an NFT ticket management system.
- We are building a ticketing and ticket management system that ustilizes the technological advantages of NFTs to make the ticket management easier to use, more secure, and fairer. 
- We are built on NEAR using the Mintbase API
- We believe it is about time that the whole ticket industry is disrupted, and that NFTs technology is the best to do that with.
