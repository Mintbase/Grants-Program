...
<details>
  <summary><b>I am starting a company that [...]. I want to use Mintbase to build a blockchain/parachain and connect [...]. Would I be eligible for a grant?</b></summary>

  We do not award grants to individual companies developing their private infrastructure. However, if part of your work is to build a library or another piece of software that could be of interest to the general Mintbase ecosystem and ask for funding specific to that, we are happy to look into it.
</details>
