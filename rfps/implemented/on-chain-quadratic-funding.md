...
| 2.  | Test 1 | Set up a test network and leverage the extrinsics tabs of polkdaot.js to test the implementation and improve it. The Mintbase provides a small matching pool as a incentive. | 
...
| 2.  | Test 2 | Test the newly created UI. The Mintbase provides another small matching pool as a incentive. | 
