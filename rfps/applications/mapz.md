...
__A Brief Description of Mapz:__
...
__Relation to / Integration into the Mintbase / NEAR Ecosystem:__
...
Decentralized Front-end PoC: Mapz on ICP Network https://onzmk-taaaa-aaaal-acw4a-cai.icp0.io/ <br>
**Documentation and Research**
Our development process is thoroughly documented, from Postgres database structure and back-end API design to UI design files in Figma. The technological backbone comprises React (Next.js), React Native, and Postgres, with test NFTs on the Polygon Mumbai network and our decentralized PoC on the ICP network. <br>
...
We are in active discussions with the NEAR Foundation to explore the deployment of our technology stack on the NEAR blockchain. These talks are aimed at leveraging NEAR's capabilities to further enhance the functionality and user experience of our Mapz platform. <br>
